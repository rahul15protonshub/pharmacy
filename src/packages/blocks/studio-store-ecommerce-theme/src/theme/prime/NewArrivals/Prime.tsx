                                        ...
                                        image={
                                            (
                                                (
                                                    ...
                                                    slicedProducts[0].attributes.images.data[0].attributes.url
                                                ) ||
                                                defaultImage
                                            )
                                        }
                                                    ...
                                                    image={
                                                        (
                                                            (
                                                                ...
                                                                slicedProducts[1].attributes.images.data[0].attributes.url
                                                            ) ||
                                                            defaultImage
                                                        )
                                                    }
                                                    onClick={() => history.push(`/shop/${slicedProducts[1].id}`)}
                                                />
                                            )
                                        }
                                    </Col>
                                                        ...
                                                        image={
                                                            (
                                                                (
                                                                    ...
                                                                    slicedProducts[2].attributes.images.data[0].attributes.url
                                                                ) ||
                                                                defaultImage
                                                            )
                                                        }
                                                        onClick={() => history.push(`/shop/${slicedProducts[2].id}`)}
                                                    />
                                                )
                                            }
                                        </Col>
                                                        ...
                                                        image={
                                                            (
                                                                (
                                                                    ...
                                                                    slicedProducts[3].attributes.images.data[0].attributes.url
                                                                ) ||
                                                                defaultImage
                                                            )
                                                        }
                                                        onClick={() => history.push(`/shop/${slicedProducts[3].id}`)}
                                                    />
                                                )
                                            }
                                        </Col>
