...
export const Ultra: any = withRouter((props: UltraProps) => {
  const renderItem = (product: any) => {
    ...
    productSaleprice = catalogue_variant_in_stock
      ? catalogue_variant_in_stock.attributes.price_including_tax
      : catalogue_variant_in_stock?.attributes.price_including_tax;
    return (
      <>
  ...
  return (
    <section className="simple-product-layout ds-mb-40 ds-mb-md-80 ds-mb-lg-104 carousel-responsive-container">
      <Container className="simple-product-layout__container">
        <SectionHeading
