...
export const Bold: any = withRouter((props: any) => {
  ...
  function getList() {
    ...
    props.collection &&
      props.collection.forEach((product: any, index: number) => {
        ...
        list.push(
          <div
            className="templatetwo-product-container slider-container"
            key={index}
          >
            <div className="item-slider">
              <div
                ...
                className="templatetwo-product product-slider-cpnt text-center"
                style={{
              ...
              >
                ...
                <div class="overlay">
                  <div className="product-detail-container">
                    <p className="productName">{product.attributes.name}</p>
  ...
  const isTabletMid = useMediaQuery({ query: "(max-width: 1200px)" });
