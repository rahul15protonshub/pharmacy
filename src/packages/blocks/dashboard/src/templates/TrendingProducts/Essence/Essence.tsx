...
export const Essence: any = withRouter((props: any) => {
  ...
  function getList() {
    ...
    props.collection &&
      props.collection.forEach((product: any, index: number) => {
        ...
        list.push(
          <div
            className="templatefour-product-container slider-container"
            key={index}
          >
            <div className="item-slider">
              <div className="templatefour-product product-slider-cpnt-template1 text-center">
                <div
                  className="templatefour-product-image-container"
  ...
  // let list: any = [];
  const isTabletMid = useMediaQuery({ query: "(max-width: 1292px)" });
  if (
    props.collection &&
  ...
  return props.collection &&
    ...
    props.collection.length > 0 &&
    showCard ? (
    <section className="templatefour-product-slider product-slider ds-mb-40 ds-mb-md-80 ds-mb-lg-104">
      <Container>
        {/* <TitleBar name={props.name} onViewMore={props.onViewMore} /> */}
        <SectionHeading
          className="mx-3 mx-md-0 mb-2 mb-md-40 heading-center"
