      ...
      <View style={styles.dashboardItemView}>
        ...
        >
          ...
          >
            <Text
              style={{
                fontSize: this.isPlatformWeb() ? 18 : RFValue(18),
                textAlign: "center",
              }}
            >
            ...
            <Text
              style={{
                fontSize: this.isPlatformWeb() ? 12 : RFValue(12),
                textAlign: "center",
              }}
            >
          ...
          >
            <Text
              style={{
                fontSize: this.isPlatformWeb() ? 14 : RFValue(14),
                textAlign: "center",
              }}
            >
        ...
        >
          ...
          <View style={{ flex: 1, marginHorizontal: wp("2%") }}>
            ...
            {this.state.errorMsg === "" ? (
              ...
              >
                <Text
                  style={{ fontSize: this.isPlatformWeb() ? 18 : RFValue(18) }}
                >
                  {this.state.errorMsg}
                </Text>
              </View>
