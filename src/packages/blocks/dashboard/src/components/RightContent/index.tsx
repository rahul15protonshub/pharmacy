...
const RightContent: React.FunctionComponent<RightContentProps> = (props: RightContentProps) => {
    const {
        banners, toggeProduct, products, onScrollEnd, loading, onProductAddToWishlist,
        ...
        <div className='right-content'>
            ...
            {/*loading && <div style={{
                ...
                <div className='card_group' onScroll={handleScroll}>
                    <Row style={{flex: 1}}>
                        {products ? products?.length === 0 ? <Col><Alert color="warning">No products found.</Alert></Col> : products?.map(product => (
