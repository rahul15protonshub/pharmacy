...
var host = require('../../../framework/src/config.js').baseURL.replace("http://", '').replace("https://", '');        

var cmd = `cd ../../../../ && node endPointTest.js --host ${host} --path ${config.recentSearchAPiEndPoint} --method GET`
