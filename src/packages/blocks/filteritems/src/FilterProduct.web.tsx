  ...
  pager(totalPages,currentPage)  {
    ...
    for (let i=1;i <= totalPages;) {
      if (i <= 3 || //the first three pages
        ...
        pagination.push(
          <div onClick={()=>{this.getCurrentPage(i-1)}} className={currentPage==i ?  "active": ""}>{i}</div>
        );
        i++;
    ...
    return (
      <div>
            ...
            <Row>
              <Col>
                    ...
                    {/* <Col>
                      <div className="abayas yt-shop-category-name">
                        ...
                        <div  className="align-item-center responsive-css d-flex">
                          ...
                          <div style={{flex:1}} className="desktopSelectedfilter selectedprops yt-selected-filter-wrap">
                          ...
                          <div style={{alignItems:'center'}} className="recomdrop yt-recommend-inner d-flex">
                ...
                <div className="mobileSelectedfilter selectedprops yt-selected-filter-wrap">
                  <Row>
                    <Col md={9}>
                      <div style={{marginLeft:'24px'}} className="yt-filter-selected d-flex align-items-center flex-wrap">
                        {this.state.searchQuery && this.state.searchQuery != "" &&
                          <span className="yt-flt-tag">
                            {
                              this.state.searchQuery
        ...
        {this.state.filterProducList.length != 0 ? (
          <>
            <ProductListCard
              ...
              increaseOrDecreaseCartQuantity={this.increaseOrDecreaseCartQuantity}
        ...
        {/* <div className="loadMoreBtn"> */}
          ...
          {/* {(!this.state.loading && this.state.filterProducList.length != 0) && <div className="productPagination">
              <div className={this.state.page == 1 && "disablePagination"} style={{display:"flex"}} onClick={()=>{this.previousPage()}}> 
                 <div>
                    &lsaquo;
                  </div>
                  <div>Previous</div>  
                ...
                <div className={this.state.page == this.state.totalPage && "disablePagination"}  onClick={()=>{this.nextPage()}} style={{display:"flex"}}>
                  <div>Next</div>
                  <div>&rsaquo;
                  </div> 
                </div>  
