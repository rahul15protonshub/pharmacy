                ...
                <div className="container footer-internal-content">
                       <div className="row">
                           <div className="col-lg-3 col-sm-3 col-xs-12">
                               <div className="footer-contact-details" style={{cursor:"pointer"}} onClick={() => this.props.history.push('/contact-us')}>
                                   <h2 >Contact us</h2>
                                   <p >Send a Message</p>
                                   <p>+{JSON.parse(localStorage.getItem('countryCode') || '{}')?.countryPinCode} {this.state.theamData?.commonTextsContent?.callUs} </p>
                               </div>
                           </div>
                           <div className="col-lg-3 col-sm-3 col-xs-12">
                                <div className="footer-contact-details" style={{cursor:"pointer"}} >
                                   <h2 onClick={() => {this.props.history.push("/aboutus");}}>About us</h2>
                                   <p onClick={() => {this.props.history.push("/aboutus");}}>Customer Reviews</p>
                                   <p onClick={() => {this.props.history.push("/help-center/FAQs");}}>FAQs</p>
                               ...
                               <div className="footer-contact-details footer-icon-tab">
                                  ...
                                  {this.state.isShowFB && (
                                       <div className="col-lg-auto col-sm-auto icon-tab">
                                           <a href={this.state.theamData ?. footerContent ?. facebookSrc} target="_blank">
                                   ...
                                   {this.state.isShowInsta && (
                                       <div className="col-lg-auto col-sm-auto icon-tab">
                                           <a href={this.state.theamData ?. footerContent ?. instagramSrc} target="_blank">
                                    ...
                                    {this.state.isShowTwitter && (
                                       <div className="col-lg-auto col-sm-auto icon-tab">
                                           <a href={this.state.theamData ?. footerContent ?. twitterSrc} target="_blank">
                                    ...
                                    {this.state.isShowYouTube && (
                                       <div className="col-lg-auto col-sm-auto icon-tab">
                                           <a href={this.state.theamData ?. footerContent ?. youtubeSrc} target="_blank">
                           ...
                           <div className="col-lg-3 col-sm-3 col-md-3 col-xs-12 xs-mob">
                               <div className="footer-contact-details">
                                   <h2>Download App</h2>
                                   <div className="row footerdownload footer-tab-view">
                                       <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 mob mobicon">
                                            <a href="https://play.google.com/store" target="_blank">
                                               <img src={playStoreImage} alt="playstore" />
                                           </a>
                                           
                                       </div>
                                       <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 mob xs-mob">
                                           <a href="https://www.apple.com/in/app-store/" target="_blank">
                                           <img style={{marginLeft: "10px"}} src={appStoreImage} alt="appstore" />
                                           </a>
                                       </div>
                                   </div>
                               </div>
